        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-8">
          {technologies.map((tech, index) => (
            <motion.div
              ...
              className={`group relative p-6 rounded-2xl bg-white border border-slate-200 transition-all duration-300 shadow-sm hover:shadow-lg ${tech.color}`}
            >
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h4 className="text-sm font-bold text-slate-600 group-hover:text-slate-900 mb-3 transition-colors">
                  {tech.name}
                </h4>
